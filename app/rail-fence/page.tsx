...
export default function RailFencePage() {
  ...
  return (
    <MobileShell title="Menu 2: Rail Fence Cipher" subtitle="Transposisi Zig-Zag Klasik">
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-slate-300 flex justify-between">
            <span>{mode === 'encrypt' ? 'Plaintext (Teks Asli)' : 'Ciphertext (Teks Transposisi)'}</span>
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-xs font-semibold text-slate-300 flex items-center gap-1.5">
              ...
              Kedalaman Rel (Jumlah Baris / Rails): <span className="text-emerald-400 font-mono font-bold">{rails} Rel</span>
            </label>
